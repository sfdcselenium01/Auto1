...
TC1 - Check Filters on Advanced Searh Page
    ...
    Comment    And User is on Advanced Search Page
    Comment    When User Select Filter for First registration
    Comment    And User Select Filter for Price Decsending
    Comment    Then Verify all cars are filtered by First Registration
    Comment    And Verify all Cars are Filtered By Price Descending
...
Open URL AutoHero
    ...
    Sleep    5
    Page Should Contain Element    //a[contains(text(),'Jetzt dein Auto finden')]
